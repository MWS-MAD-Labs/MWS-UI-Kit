...
- Add opt-in Learnspace, SHIELDSpace, SAFESpace and CARESpace light/dark sub-themes via root data-space attributes, typed Space metadata, and palette/component guidance. Preserve existing defaults and shared status colors.
